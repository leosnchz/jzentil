 ...
 * @uses test_admin_header_style()
 * @uses test_admin_header_image()
 */
...
endif; // test_header_style

if ( ! function_exists( 'test_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see test_custom_header_setup().
 */
function test_admin_header_style() {
?>
	<style type="text/css">
...
endif; // test_admin_header_style

if ( ! function_exists( 'test_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see test_custom_header_setup().
 */
function test_admin_header_image() {
?>
	<div id="headimg">
